...
// Define API routes
const usersReport=require('./v1/routes/usersReport')
const productReport=require('./v1/routes/productReport')
const dashboard=require('./v1/routes/dashboard')
const orderReport=require('./v1/routes/orderReport')
const vendorPanelReport=require('./v1/routes/vendorPanelReport')
const adminPanelReport=require('./v1/routes/adminPanelReport')

app.use("/", usersReport);
app.use("/", productReport);
app.use("/", dashboard);
app.use("/", orderReport);
app.use("/vendor", vendorPanelReport);
app.use("/admin", adminPanelReport);
