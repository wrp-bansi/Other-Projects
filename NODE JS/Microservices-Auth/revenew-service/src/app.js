...
// Define API routes
const requestPayment=require('./v1/routes/requestPayment')
const walletHistory=require('./v1/routes/walletHistory')

app.use('/vendor/request-payment',requestPayment)
app.use('/',walletHistory)
